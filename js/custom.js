...
var Agency = function(){
	...
	var MagnificPopup = function(){
		...
		jQuery('#OfficePhoto.mfp-gallery').magnificPopup({
			delegate: '.mfp-link',
			type: 'image',
	...
	var MagnificPopup2 = function(){
		'use strict';	
		/* magnificPopup function */
		jQuery('#masonry2.mfp-gallery').magnificPopup({
			delegate: '.mfp-link',
			type: 'image',
			tLoading: 'Loading image #%curr%...',
			mainClass: 'mfp-img-mobile',
	...
	var masonryBox2 = function(){
		'use strict';
		/* masonry by  = bootstrap-select.min.js */
		if(jQuery('#masonry2, .masonry').length)
		{
			var self = $("#masonry2, .masonry");
			if(jQuery('.card-container').length)
		    {
				self.imagesLoaded(function () {
					self.masonry({
	...
	/* Website Launch Date */ 
	var WebsiteLaunchDate = new Date("2021/02/01");
	var monthNames = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];
	//WebsiteLaunchDate.setMonth(WebsiteLaunchDate.getMonth() + 1);
	WebsiteLaunchDate.setMonth(WebsiteLaunchDate.getMonth());
